...
if ($pageToDisplay === 'home') {
    ...
    require __DIR__ . '/inc/data.php';
    $author=$_GET['id'] ; //c un chiffre 
    $articlesList = [];
    foreach ($dataArticlesList as $article){
    //var_dump($dataAuthorsList[$author]) ;
    //var_dump($dataCategoriesList[$category]); //c une categorie
        if($article->author===$dataAuthorsList[$author]->name) {
    ...
    require __DIR__ . '/inc/data.php';
    $category=$_GET['id'] ; //c un chiffre 
    $articlesList = [];
    foreach ($dataArticlesList as $article){
    //var_dump($article->category) ;
    //var_dump($dataCategoriesList[$category]); //c une categorie
        if($article->category===$dataCategoriesList[$category]->category) {
            // $articlesList[] =$article;
            array_push($articlesList,$article);
            //var_dump($articlesList) ;
        }
